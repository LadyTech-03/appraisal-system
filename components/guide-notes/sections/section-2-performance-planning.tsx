    ...
    return (
        <div className="space-y-6 max-w-4xl text-sm">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
                <div className="flex items-baseline gap-x-2 border-b border-black/30 pb-1">
                    <span className="font-bold whitespace-nowrap">APPRAISEE'S SIGNATURE:</span>
                    <span className="flex-1 text-muted-foreground">_________________</span>
                    <span className="font-bold">DATE:</span>
                    <span className="text-muted-foreground">[Planning Date]</span>
                </div>
                <div className="flex items-baseline gap-x-2 border-b border-black/30 pb-1">
